namespace Lyra.Api.Infrastructure
{
    ...
    {
        /// <summary>
        /// Only allow specified controllers and prevents assembly scanning.
        /// </summary>
        ...
        public static IMvcBuilder UseSpecificControllers(
            this IMvcBuilder mvcCoreBuilder,
        ...
        private class SelectedControllersApplicationParts : ApplicationPart, IApplicationPartTypeProvider
        {
            ...
            {
                this.Name = "Only allow selected controllers";
            }
            public SelectedControllersApplicationParts(Type[] types)
            {
                this.Types = types.Select(x => x.GetTypeInfo()).ToArray();
            }
